...
package learning.kafka.examples;

import java.util.ArrayList;
import java.util.List;

import learning.kafka.examples.types.HadoopRecord;
import learning.kafka.examples.types.LineItem;
import learning.kafka.examples.types.Notification;
import learning.kafka.examples.types.PosInvoice;
